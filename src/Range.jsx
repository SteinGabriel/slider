...
class Range extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        const equalMin = this.props.min === nextProps.min
        const equalMax = this.props.max === nextProps.max
        if (
            equalMin &&
            equalMax &&
        ...
        const sameLenght = nextBounds.length === bounds.length
        if (sameLenght && nextBounds.every((v, i) => v === bounds[i])) return
    ...
    onStart(position) {
        ...
        this.prevMovedHandleIndex = this.getBoundNeedMoving(value, closestBound) // controls if the range will expand to right or left
        this.setState({
        ...
        const nextBounds = this.getNextBounds(bounds, value)
        this.setState({ bounds: nextBounds })
        this.props.onChange(bounds)
    }

    getNextBounds(bounds, value) {
